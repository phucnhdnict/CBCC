...
<form id="nhucaudaotaoFrm" name="nhucaudaotaoFrm" method="post" class="form-horizontal" enctype="multipart/form-data">
	...
	<div style="clear: both;"></div>
	<input type="hidden" id="empid" name="empid" value="<?php if (isset($data_nhucaudaotao[0]->empid)) echo $data_nhucaudaotao[0]->empid;else echo $model->getEmpidByJos(jFactory::getUser()->id);?>" />
...
jQuery(document).ready(function($){
	$('#nhucaudaotaoFrm').validate({
		...
		submitHandler: function(){
			...
			var data_nhucaudaotaoFrm = $('#nhucaudaotaoFrm').serialize();
