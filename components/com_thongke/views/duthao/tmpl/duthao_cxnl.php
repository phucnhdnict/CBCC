...
$luong_bac					=	$data->luong_bac;
$thoidiemhuong				=	$data->luong_ngaybatdau;
$thoidiemhuong2			= explode("-", $thoidiemhuong);
$luong_ngayhuong        = 'ngày '.$thoidiemhuong2[2].' tháng '.$thoidiemhuong2[1].' năm '.$thoidiemhuong2[0];
$luong_heso_cu			=	$data->luong_heso;
$luong_vuotkhung_cu	=	$data->luong_vuotkhung;
if ($luong_vuotkhung_cu >0) $vk_cu = ', vượt khung: '.$luong_vuotkhung_cu;
...
margin-left:1.25in;margin-bottom:.0001pt;text-align:justify;text-indent:-.25in'><span
style='font-size:13.0pt'>-<span style='font:7.0pt Times New Roman'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><span style='font-size:13.0pt'>Từ ngạch: $luong_tenngach, mã ngạch ($luong_mangach), bậc: $luong_bac, hệ số lương: $luong_heso_cu $vk_cu,  từ $luong_ngayhuong</span></p>

<p class=MsoNormal style='margin-top:6.0pt;margin-right:0in;margin-bottom:0in;
margin-left:1.25in;margin-bottom:.0001pt;text-align:justify;text-indent:-.25in'><span
style='font-size:13.0pt'>-<span style='font:7.0pt Times New Roman'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
</span></span><span style='font-size:13.0pt'>Sang ngạch: ..............., mã ngạch (..........), bậc: ........., hệ số lương: ............., từ ngày ........ tháng ....... năm ........</span></p>
