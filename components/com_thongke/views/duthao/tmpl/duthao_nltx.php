...
$vk_moi						=	$data->vk_moi;
$thoidiemnangluong		=	$data->thoidiemnangluong;
$thoidiemhuong2			= explode("-", $thoidiemnangluong);
$ngayhuong_moi  	= 'ngày '.$thoidiemhuong2[2].' tháng '.$thoidiemhuong2[1].' năm '.$thoidiemhuong2[0];
...
<p class=MsoNormal align=center style='text-align:center'><b><span
style='font-size:13.0pt'>Về việc nâng bậc lương thường xuyên đối với $congvienchuc</span></span></b></p>
