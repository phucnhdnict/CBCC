            ...
            receiveEvent: function(a, b) {
                ...
                if (this.handlers[a])
                    for (var d = 0, e = this.handlers[a].length; d <
                        ...
                        else if ("string" == typeof f) m[f](this, b)
                    }
            }
        };
            ...
            _fnConstruct: function(a) {
                ...
                this.s.dt.aoDestroyCallback.push({
                    ...
                    fn: function() {
                        ...
                        var a = f.inArray(b, TableTools._aInstances); - 1 !== a && TableTools._aInstances.splice(a, 1)
                    }
                })
            },
            ...
            _fnRowSelectConfig: function() {
                if (this.s.master) {
                    ...
                    f(b.nTBody).on("click.DTTT_Select", this.s.custom.sRowSelector, function(c) {
                        var d = this.nodeName.toLowerCase() === "tr" ? this : f(this).parents("tr")[0],
                            e = a.s.select,
            ...
            _fnPrintStart: function(a) {
                ...
                for (e in d)
                    if ("i" != e && "t" != e && 1 == e.length)
                        for (var g = 0, i = d[e].length; g < i; g++) this.dom.print.hidden.push({
                            node: d[e][g],
                            display: "block"
