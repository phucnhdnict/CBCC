...
// Generate script file links
		...
		{
			//$scripts[$strSrc] = $strAttr['offset'];			
			$scripts[$strAttr['offset']][] = $strSrc;
			//$index ++;
			//var_dump($scripts);
		}
		ksort($scripts);
		...
		{
			//$scripts[$strAttr['offset']][$strSrc] = $strAttr;
			//var_dump($v);
			foreach ($v as $index => $strSrc)
			{
				$strAttr = $document->_scripts[$strSrc];
