...
class JDocument
{
	 ...
	 * @since   11.1
	 */
	public function addScript($url,$type = "text/javascript", $defer = false, $async = false, $offset = 0)
	{		
		if ($this->_scripts[$url] == null || ($this->_scripts[$url]['offset'] > $offset)) {
			$this->_scripts[$url]['mime'] = $type;
			$this->_scripts[$url]['defer'] = $defer;
			$this->_scripts[$url]['async'] = $async;
			$this->_scripts[$url]['offset'] = $offset;			
		}
		return $this;
	}
	/**
